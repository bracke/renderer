...
package body Bootstrap is
   ...
   procedure Run_Test (T : in out Test) is
      ...
      type Button_Style is record
         Fill   : Pixel;
         Border : Pixel;
      end record;

      Button_Styles   : constant array (1 .. 8) of Button_Style :=
      ...
      for I in Button_Styles'Range loop
         Draw_Rounded_Rectangle
           (Context       => C,
            ...
            Radius_BR     => Radius,
            Radius_BL     => Radius,
            Fill_Gradient => Gradient'(Kind       => Solid,
                                       Stop_Count => 1,
                                       Stops      =>
                                         [1 => (Position => 0.0,
                                                Color    => Button_Styles(I).Fill)],
                                       others     => <>),
            Border_Color  => Button_Styles(I).Border,
            Border_Size   => 1,
